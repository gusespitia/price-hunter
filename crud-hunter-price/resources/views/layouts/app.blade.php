            ...
            <div class="container">     
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                      <li class="nav-item">
                        <a class="nav-item nav-link {{ Request::is('product*') ? 'active' : '' }}" href="{{ route('product.index') }}">Products </a>
                      </li>
                      ...
                      <li class="nav-item">
                        <a class="nav-item nav-link {{ Request::is('store*') ? 'active' : '' }}" href="{{ route('store.index') }}">Stores </a>
                      </li>
